...
<div class="home">
        ...
        <div class="intro_div end">
            <div class="intro_text text_right">
                    <div class="text_icono">
                        <img src="../../build/img/cibercryme.svg" alt="cybercrime icon">
                        <p><span>$10.5</span><br>trillion</p>
                    </div>
    ...
    <section class="us_section">
        ...
        <h2 class="us_title">Who are we?</h2>
        <div class="us_div">
            <div class="us_text">
    ...
    <section class="services_section">
        <h2 class="services_title">What do we do?</h2>
        <div class="services_div">
            ...
            <div class="service">
                ...
                <p class="service_title">Microsoft Environment <br>Security</p>
            </div>
            <div class="service">
            ...
            <div class="service">
                ...
                <p class="service_title">EDR/XDR</p>
            </div>
            <div class="service">
                <img src="../../build/img/training.svg" alt="" class="service_icon">
                <p class="service_title">Professional Cybersecurity <br>Training</p>
            </div>
            <div class="service">
            ...
            <div class="service">
                ...
                <p class="service_title">Code Security</p>
            </div>
        </div>
        <div class="button_div">
